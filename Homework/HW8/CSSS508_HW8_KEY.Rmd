...
### Question 1.8: Create a plot (you chose precisely what plot) using the variables Year, Maximum Score, and Name. Get creative!
...
### Question 2.1: Using your data from part 1, create a `basic` ggplot (using the `ggplot2` function) displaying the latitude/longitude of each coffee shop in King County.
