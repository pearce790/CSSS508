...
> with "rownames". That's because matrices stores "column names" but nothing else!
...
> Answer: They are still equal (element_wise). This tells us the cbind and data.frame are ultimately functioning
> to accomplish the same task in this case.
