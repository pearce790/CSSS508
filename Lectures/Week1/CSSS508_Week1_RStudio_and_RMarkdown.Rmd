---
title: "CSSS 508, Week 1"
subtitle: "Syllabus and Lecture 1: Introduction to R, RStudio, and RMarkdown"
...
* Go through Lecture 1: Introduction to R, RStudio, and RMarkdown
...
* Program, year, and research interests (if applicable)
...
* **Office Hours:** Wednesdays, 9-10am (on Zoom; link on Canvas)
...
Homework instructions/templates, peer grading instructions, and the homework schedule can be found on the [Homework](https://pearce790.github.io/CSSS508/homework.html) page of the course website.
...
Learning to code is hard and requires lots of practice. Peer grading is a great way to help your coding skills sink in and develop faster!
...
* Leave constructive comments -- more than just saying "good job!"
    ...
    + Earlier assignments will need more feedback, late assignments less.
* **Email me** if you would like the instructor to regrade your assignment or provide feedback if no peer review was given.
...
* Getting Help: If you ever find yourself struggling to keep up, please let me know! I am here to help. Try chatting after class, office hours, or email.
