...
We need to do this every time we open a new R session. Where should be put this code?
...
The [tidyverse](http://tidyverse.org/) is a package of packages, including:
...
<img src="https://pbs.twimg.com/media/FTN0BMvXsAMIS2D.jpg" width="40%"/>
