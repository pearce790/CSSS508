...
* **Arguments** (aka inputs, parameters): things the user passes to the function that affect how it works
    ...
    + `na.rm = FALSE` is example of setting a default value
    + In this example, `x`, `na.rm` values won't exist outside of the function
--

* **Body**: The actual operations inside the function.
--

* **Return**: The output inside `return()`. Could be anything (or nothing!)
